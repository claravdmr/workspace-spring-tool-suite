...
@Slf4j
@Service
public class ConsumerPostedCustomerEventTestService extends ConsumerLatch<CustomerEventDto> {

	@KafkaListener(topics = "${custom.topic.customer.posted}", groupId = "${spring.kafka.consumer.group-id-test}", containerFactory = "containerFactory")
