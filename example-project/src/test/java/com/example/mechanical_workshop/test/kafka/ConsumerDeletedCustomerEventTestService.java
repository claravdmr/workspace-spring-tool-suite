...
@Slf4j
@Service
public class ConsumerDeletedCustomerEventTestService extends ConsumerLatch<CustomerEventDto> {

	@KafkaListener(topics = "${custom.topic.customer.deleted}", groupId = "${spring.kafka.consumer.group-id-test}", containerFactory = "containerFactory")
