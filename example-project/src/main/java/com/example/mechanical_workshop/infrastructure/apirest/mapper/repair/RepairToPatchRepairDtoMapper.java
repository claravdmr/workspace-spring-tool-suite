...
import com.example.mechanical_workshop.infrastructure.apirest.dto.repair.RequestPatchRepairDto;

@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RepairToPatchRepairDtoMapper extends BaseMapper<Repair, RequestPatchRepairDto> {
