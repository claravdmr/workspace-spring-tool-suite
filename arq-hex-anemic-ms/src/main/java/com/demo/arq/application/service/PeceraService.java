...
public class PeceraService implements PeceraServiceInputPort {
	...
	@Autowired
	PeceraJpaRepositoryOutputPort peceraJpaRepositoryOutputPort;
	...
	public String crearPecera(@Valid Pecera input) {
		...
		// Si nos pidieran mantener la BBDD de Jpa con los mismos registros que la de
		// MongoDB deberiamos ir añadiendo, modificando y eliminando los elementos al
		// igual que en MongoDB
		BigDecimal idJpa = peceraJpaRepositoryOutputPort.crearPecera(input);
		input.setIdJpa(idJpa);
	...
	public void modificacionParcialPecera(@Valid Pecera input) throws BusinessException {
		...
		// Aunque guardamos el id que no deben enviar desde fuera
		input.setIdJpa(opt.get().getIdJpa());
		...
		// MongoDB deberiamos ir añadiendo, modificando y eliminando los elementos al
		// igual que en MongoDB
		peceraJpaRepositoryOutputPort.modificarPecera(updated);
	...
	public void modificacionTotalPecera(@Valid Pecera input) throws BusinessException {
		...
		// MongoDB deberiamos ir añadiendo, modificando y eliminando los elementos al
		// igual que en MongoDB
		peceraJpaRepositoryOutputPort.modificarPecera(input);
	...
	public void eliminarPecera(@Valid String id) throws BusinessException {
		...
		// MongoDB deberiamos ir añadiendo, modificando y eliminando los elementos al
		// igual que en MongoDB
		peceraJpaRepositoryOutputPort.eliminarPecera(opt.get().getIdJpa());
